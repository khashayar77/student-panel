...
const ELEMENT_DATA: IEdit[] = [
  { FirstName: 'خشایار', LastName: 'پنبه ئیان', course: 'ریاضی 1', scores: '17', TestDate: '2019/11/06', StudentID: '1', status: 'قبول' },
  { FirstName: 'امیر', LastName: 'احمدی', course: 'ریاضی 2', scores: '12', TestDate: '2019/11/12', StudentID: '2', status: 'قبول' },
  { FirstName: 'مهدی', LastName: 'جابری', course: 'دیفرانسیل', scores: '11', TestDate: '2019/11/09', StudentID: '3', status: 'مردود' },
  { FirstName: 'علی', LastName: 'طاهری', course: 'برنامه نویسی', scores: '19', TestDate: '2019/11/11', StudentID: '4', status: 'قبول' },
  { FirstName: 'پریسا', LastName: 'اسکندری', course: 'فیزیک', scores: '10', TestDate: '2019/11/12', StudentID: '5', status: 'مردود' },
];
...
export class EditComponent {
  ...
  openBottomSheet(selectedStudent: IEdit): any {
    ...
    bottomSheetRef.afterDismissed().subscribe(result => {
      if (result != undefined) {
        ...
        var newstatus = (result.status != this.selectedStudent.status ? result.status : "");
